...
#Run lengths/dates
#Arctic permafrost sites benefit from longer spinup for deep soil thermal/carbon equilibration
nyears_ad      =  300     #number of years for ad spinup
nyears_final   =  600     #number of years for final spinup, SP run, or FATES C-only
